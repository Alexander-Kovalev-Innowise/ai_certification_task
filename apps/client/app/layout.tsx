...
import { refreshSession } from '../src/lib/api/apiClient';
...
// Mounted at the ROOT layout (not a role layout) deliberately: an
// impersonated session renders *inside* the target's own role layout, so the
// banner has to sit above that entire subtree. Left as a render-nothing
// slot here per Task 10.8's "Do" — the real component doesn't exist yet.
